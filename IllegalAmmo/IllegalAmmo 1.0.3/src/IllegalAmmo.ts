...
class ILLEGALAmmo implements IPostAkiLoadMod, IPostDBLoadMod, IPreAkiLoadMod
{
	...
	private clone762x25TT(ammoToClone:string, newAmmoID:string)
    {
	    ...
	    ammoID._props.MisfireChance = 0.1;
        ammoID._props.MalfMisfireChance = 0.1;
        ammoID._props.DurabilityBurnModificator = 2.5;
        ammoID._props.HeatFactor = 1.75;
	...
	private clone762x39(ammoToClone:string, newAmmoID:string)
    {
        ...
        ammoID._props.DurabilityBurnModificator = 3.5;
        ammoID._props.HeatFactor = 2.25;
        ammoID._props.MalfFeedChance = 0.055;
        ammoID._props.BackgroundColor = "tracerRed"
        ammoID._props.Finallowed = false;
        logger.logWithColor("Ammo " + ammoID._id + " Added", LogTextColor.green);
	...
	private clone762x51(ammoToClone:string, newAmmoID:string)
    {
	    ...
	    ammoID._props.MisfireChance = 0.2;
        ammoID._props.MalfMisfireChance = 0.2;
        ammoID._props.DurabilityBurnModificator = 4.5;
        ammoID._props.HeatFactor = 2.75;
        ammoID._props.MalfFeedChance = 0.115;
        ammoID._props.BackgroundColor = "tracerRed"
        ammoID._props.Finallowed = false;
        logger.logWithColor("Ammo " + ammoID._id + " Added", LogTextColor.green);
	...
	private clone40x46(ammoToClone:string, newAmmoID:string)
    {
        ...
        ammoID._props.PenetrationPower = 60;
		ammoID._props.PenetrationChance = 1;
		ammoID._props.MisfireChance = 0.5;
        ammoID._props.MalfMisfireChance = 0.5;
        ammoID._props.DurabilityBurnModificator = 10;
        ammoID._props.HeatFactor = 6;
        ammoID._props.MalfFeedChance = 0.32;
        ammoID._props.BackgroundColor = "tracerRed"
        ammoID._props.Finallowed = false;
        logger.logWithColor("Ammo " + ammoID._id + " Added", LogTextColor.green);
	...
	private clone26x75(ammoToClone:string, newAmmoID:string)
    {
        ...
        ammoID._props.MalfMisfireChance = 0.5;
        ammoID._props.DurabilityBurnModificator = 100;
        ammoID._props.HeatFactor = 100;
        ammoID._props.MalfFeedChance = 0.32;
        ammoID._props.BackgroundColor = "tracerRed"
        ammoID._props.Finallowed = false;
        logger.logWithColor("Ammo " + ammoID._id + " Added", LogTextColor.green);
	...
	private clone86x70(ammoToClone:string, newAmmoID:string)
    {
        ...
        ammoID._props.MisfireChance = 0.25;
        ammoID._props.MalfMisfireChance = 0.25;
        ammoID._props.DurabilityBurnModificator = 5.5;
        ammoID._props.HeatFactor = 3.25;
        ammoID._props.MalfFeedChance = 0.16;
        ammoID._props.BackgroundColor = "tracerRed"
        ammoID._props.Finallowed = false;
        logger.logWithColor("Ammo " + ammoID._id + " Added", LogTextColor.green);
